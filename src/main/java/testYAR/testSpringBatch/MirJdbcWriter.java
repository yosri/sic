...
public class MirJdbcWriter implements ItemWriter<SngcMirTrim> {
	...
	public void write(List<? extends SngcMirTrim> items) throws Exception {
		for (SngcMirTrim sngcMir : items) {
			// final Object object[] = { sngcMir.getTypeEnregistrement(), sngcMir.getZoneIdAssure(), sngcMir.getZonePartenaire(), sngcMir.getZoneTrimestresRegime(),
			// sngcMir.getZoneAnomaliesRetours() };
